...
public class SoalDasarJ extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soaldasarj);
        ...
        optionQuest = findViewById(R.id.optionquest);
        ...
        myRef.child("questions").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(list.size() > 0){
                    ...
                    Nextbtn.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            if(position == list.size()){
                                Intent scoreInent = new Intent(SoalDasarJ.this, scoreActivity.class);
                    ...
                    finish();
                    Toast.makeText(SoalDasarJ.this, "no questions", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(SoalDasarJ.this, databaseError.getMessage(),Toast.LENGTH_SHORT);
            }
        });
    }
