...
public class SoalTopologiJ extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soaltopologij);
        ...
        noIndikator = findViewById(R.id.no_indikator3);
        optionQuest = findViewById(R.id.optionquest3);
        Sharebtn = findViewById(R.id.btn_share3);
        Nextbtn = findViewById(R.id.btn_next3);

        list = new ArrayList<>();

        myRef.child("Bab3").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(list.size() > 0){
                    ...
                    Nextbtn.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            if(position == list.size()){
                                Intent scoreInent = new Intent(SoalTopologiJ.this, scoreActivity.class);
                    ...
                    finish();
                    Toast.makeText(SoalTopologiJ.this, "no questions", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(SoalTopologiJ.this, databaseError.getMessage(),Toast.LENGTH_SHORT);
